...
const TipsAndCare = () => {
  return (
    <div>
      <h2 className="text-center text-3xl mt-28 font-semibold">
        Winter Care <span className="text-pink-500 underline underline-offset-4">Tips for Pets</span>
      </h2>
            ...
            <div
              ...
              <div className="space-y-3">
                ...
                <div className="card-actions justify-start ">
                  <p>
                    <span className="text-pink-500 font-bold underline" >Tips:</span> {item.tips}
                  </p>
                </div>
